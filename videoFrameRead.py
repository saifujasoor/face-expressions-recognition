...
path = "/home/saifullah/Desktop/pro/emotion__detection/FacialExpressionRecognition"
vidcap = FileVideoStream(args["video_file"]).start() #imutils
count = 0
framecount = 0
...
if args["save"]:
    out = cv2.VideoWriter(
        path + "output.avi", cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 10, (450, 300))
...
while vidcap.more():
    ...
    face_coord = face_cascade.detectMultiScale(
        gray, 1.1, 10, minSize=(30, 30)) #detection
    for coords in face_coord:
        ...
        if ear < EYE_AR_THRESH:
            ...
            if COUNTER >= EYE_AR_CONSEC_FRAMES:
                cv2.putText(frame, "Distracted Driving", (10, 30),
        ...
        cv2.putText(frame, str(
            prediction), (10, frame.shape[0] - 25), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (225, 255, 255), 2)
